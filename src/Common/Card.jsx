  ...
  return (
    <div className="max-w-[370px] p-5 rounded-[10px] shadow-md">
      ...
      <div className="h-[200px] w-full rounded-[10px] overflow-hidden">
        <img src={thumbnail} alt={image} className="w-full h-full" />
      </div>
      {/* content */}
      ...
      <h5 className="font-NunitoSans font-bold text-2xl text-secondaryColor pb-3">
        ${Math.floor(Math.random(price) * 1500)}
      </h5>

      <div className="">
        <p className="font-NunitoSans font-normal text-base text-thirdColor absolute max-w-[370px] bg-white py-[1vw]">
