                ...
                <div className="">
                    ...
                    <div className="mt-[25px] flex">
                        ...
                        <div className="w-[160px] flex items-center justify-between ml-[40px]">
                            ...
                            <div className="">
                                <button onClick={listClick} className='text-title font-bold text-[20px] outline-none cursor-pointer w-[110px] flex justify-between items-center mb-[0.5vh]'>
                                    Location {!first ? <RiArrowDownSLine /> : <RiArrowUpSLine />}
                                </button>

                                <h4 className='text-[#6A6A6A] font-Nunito text-base outline-none'>New York</h4>
                                ...
                                <ul className="listMenu w-[150px] h-screen hidden text-black bg-[#a7a7a7] text-md font-bold text-[18px] font-Nunito  fixed top-0 ml-[110px] z-50">

                                    {
                                        api.map((el, idx) => {
                                            ...
                                            return (
                                                <li key={idx} className='border-b-[1px] border-white py-[5px] pl-[10px] hover:pl-[15px]'>
                                                    {el.region}
                                                </li>
